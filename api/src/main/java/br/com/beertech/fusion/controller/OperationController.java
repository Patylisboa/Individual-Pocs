...
public class OperationController {
    ...
    public ResponseEntity<Saldo> listSaldo(@PathVariable String uuid) {
        Optional<ContaCorrente> contaCorrente = contaCorrenteService.findByUuid(uuid);
        if (contaCorrente.isPresent()) {
            List<Operacao> transacoes = contaCorrenteService.listOperacoesByContaCorrente(uuid);
    ...
    @PostMapping("/operacao/{uuid}")
    public ResponseEntity<Operacao> saveOperations(@PathVariable String uuid,
    ...
    public ResponseEntity<TransferenciaDto> realizarTransferencia(@RequestBody TransferenciaDto transferenciaDto) {
        Optional<ContaCorrente> contaCorrenteOrigem = contaCorrenteService
                .findByUuid(transferenciaDto.getUuidContaOrigem());
        Optional<ContaCorrente> contaCorrenteDestino = contaCorrenteService
                .findByUuid(transferenciaDto.getUuidContaDestino());

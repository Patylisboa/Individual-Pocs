...
public class RestClient {
    ...
    public void sendPostAPIOperation(Operacao operacao) {
        String url = APIURL + "operacao/{uuid}";
    ...
    public void sendPostAPITransferencia(Transferencia transferencia) {
        ...
        Map<String, Object> map = new HashMap<>();
        map.put("uuidContaOrigem", transferencia.getUuidContaOrigem());
        map.put("uuidContaDestino", transferencia.getUuidContaDestino());
